...
public class brand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(48, 48, 48)
                .addComponent(category_net, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(brand_net, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Brand", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 18), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        brand_txt.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        String category_name = brand_txt.getText();
    ...
    private void edit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit_btnActionPerformed
        DefaultTableModel ddt = (DefaultTableModel)table_2.getModel();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Product Brand Updated!");
            load_tableData();
            brand_txt.setText("");
            status_combox.setSelectedIndex(-1);
    ...
    private void table_2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_2MouseClicked
         DefaultTableModel dd = (DefaultTableModel)table_2.getModel();
         int selectIndex = table_2.getSelectedRow();
         
         brand_txt.setText(dd.getValueAt(selectIndex, 1).toString());
...
//        String status = status_combox.getSelectedItem().toString();
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the "+brand_txt.getText()+" brand?", "Warning",JOptionPane.YES_NO_OPTION);
